...
import com.nhombabon.kanatraining.models.ReadCSVFile;
...
public class Common extends Application {
    ...
    public HashMap<String, String[]> mCharDataListHiragana;
    public HashMap<String, String[]> mCharDataListKatakana;
